...
export class PipelineService {
  async createPipeline(options: ProjectOptions): Promise<void> {
  ...
  private async generateAzureDevOpsPipeline(options: ProjectOptions): Promise<void> {
...
`;
  ...
  private async generateGitHubActions(options: ProjectOptions): Promise<void> {
...
`;
  ...
  private async generateDeploymentScripts(options: ProjectOptions): Promise<void> {
